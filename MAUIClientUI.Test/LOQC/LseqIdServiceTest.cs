...
{
    /// <summary>
    /// Comprehensive tests for LseqIdService CRDT ID generation
    /// Tests cover simple decimal IDs, composite IDs, conflict resolution, and concurrent edits
    /// </summary>
    public class LseqIdServiceTest
    {
        ...
        public void GenerateIdBetween_EmptyBoundaries_ReturnsOne()
        {
            ...
            var service = new LseqIdService(_clientId1);
        ...
        public void BuildCompositeIdString_SingleComponent_ReturnsCorrectFormat()
        {
            // Arrange
            var service = new LseqIdService(_clientId1);
            var components = new List<LseqIdService.IdComponent>
            {
                new LseqIdService.IdComponent { Position = 1.5m, SiteId = _clientId1 }
            };
        ...
        public void BuildCompositeIdString_MultipleComponents_ReturnsConcatenated()
        {
            ...
            var components = new List<LseqIdService.IdComponent>
            {
                new LseqIdService.IdComponent { Position = 1m, SiteId = _clientId1 },
                new LseqIdService.IdComponent { Position = 2.5m, SiteId = _clientId2 },
                new LseqIdService.IdComponent { Position = 3m, SiteId = _clientId3 }
            };
        ...
        public void GenerateIdBetweenComposite_SamePositionDifferentSites_AddsNestingLevel()
        {
            ...
            var service = new LseqIdService(_clientId3);
        ...
        public void ConcurrentInserts_TwoUsersTypingAtSameTime_GeneratesUniqueIds()
        {
            ...
            var service1 = new LseqIdService(_clientId1);
            var service2 = new LseqIdService(_clientId2);
        ...
        public void ConcurrentInserts_MultipleCharactersBetweenSamePositions_AllUnique()
        {
            ...
            var service1 = new LseqIdService(_clientId1);
            var service2 = new LseqIdService(_clientId2);
            var service3 = new LseqIdService(_clientId3);
        ...
        public void BuildCompositeIdString_EmptyComponents_ReturnsEmptyString()
        {
            ...
            // Act
            var result = service.BuildCompositeIdString(new List<LseqIdService.IdComponent>());

            // Assert
            Assert.Equal("", result);
        }

        // Note: CompositeIdToOrderableString has a bug in LseqIdService.cs line 167
        ...
        */
        ...
        {
            // Arrange
            var component = new LseqIdService.IdComponent
            {
                Position = 1.5m,
                SiteId = _clientId1
            };
        ...
        public void RealWorldScenario_CollaborativeEditing_GeneratesConsistentIds()
        {
            ...
            var user1Service = new LseqIdService(_clientId1);
            var user2Service = new LseqIdService(_clientId2);
