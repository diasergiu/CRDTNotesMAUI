...
migrate_client:
	...
	dotnet ef database update --project DatabaseLibrary --context DbContextClient
...
migrate_server:
	...
	dotnet ef migrations add $(filter-out $@,$(MAKECMDGOALS)) --project DatabaseLibrary --context DbContextServer
	dotnet ef database update --project DatabaseLibrary --context DbContextServer
